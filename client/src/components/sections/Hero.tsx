...
export default function Hero() {
  return (
    <section id="home" className="min-h-screen flex items-center text-white pt-16 bg-gradient-to-r from-primary/30 to-secondary">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid md:grid-cols-[3fr_2fr] gap-8 items-center">
          ...
          >
            ...
            <p className="text-2xl sm:text-xl opacity-90 mb-8 text-slate-700">
